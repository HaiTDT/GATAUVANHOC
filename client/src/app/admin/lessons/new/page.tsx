  ...
  return (
    <div className="max-w-4xl">
      <header className="mb-8 flex items-center gap-3">
        ...
        <h2 className="font-bold font-headline text-2xl text-primary">Thêm mới Bài học</h2>
      </header>
        ...
        <form onSubmit={submit} className="space-y-6">
          ...
          <div className="pt-6 border-t border-stone-100 flex justify-end gap-3">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="px-6 py-3 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary/90 shadow-lg shadow-primary/20 transition disabled:opacity-70 flex items-center gap-2"
            >
